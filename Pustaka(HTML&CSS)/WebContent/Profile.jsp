					...
					<div class="row">
						<div class="span4">
							<div class="logo"
								...
								<p
									style="float: left; clear: left; margin-top: -48px; margin-left: -35px">
									<img src="img/logo.jpg" alt="" width="120" heigth="120">
								</p>
								<p>
								<h1
									style="font-family: cursive; font-style: oblique; font-weight: bold; color: black; font-size: 42px; margin-top: -10px; font-stretch: semi-condensed;">PUSTAKA</h1>
								</p>
								<p>
								<h3
									style="font-family: cursive; font-style: italic; color: red; margin-left: 70px;">
									<font color="blue">></font><font color="red">></font> Sharing -
									Knowledge
								</h3>
							</div>
						</div>
								...
								<div class="menu_wrap">
									<ul class="nav sf-menu">
										...
										<li class="sub-menu"><a href="javascript:{}">Partners</a>
											<ul>
												<li><a href="sakatech.com"><span>-</span>Sakha
														Global</a></li>
												<li><a href="w3schools.com"><span>-</span>W3
														Schools</a></li>
											</ul>
										<li><a href="Cart.html">Cart</a> <%! static String user; %>
											<%   user =(String)session.getAttribute(user); %>
										<li class="sub-menu"><a href="javascript:{}"><%= user %></a>
											<ul>
												<li><a href="Profile.html"><span>-</span>Profile</a></li>
												<li><a href="Home1.html"><span>-</span>LogOut</a></li></li>
									</ul>
									<li><a href="contacts.html">Help</a></li> <br> <br>
	...
	<div class="page_container">
		...
		<div class="wrap planning">
			<div class="container">
				<div class="row">
					<div class="span3">
						<a href="#"> <span class="img_icon icon1"></span> <span
							class="link_title">Happiness</span> Liked by all Students,
							Professionals and Technology Geeks.
						</a>
					</div>
					<div class="span3">
						<a href="#"> <span class="img_icon icon2"></span> <span
							class="link_title">Global</span> Easy access to all sort of Text
							books and Online Notes.
						</a>
					</div>
					<div class="span3">
						<a href="#"> <span class="img_icon icon3"></span> <span
							class="link_title">BookMark</span> Being a Premium user, you can
							Bookmark your favourite notes and access them anywhere u need
						</a>
					</div>
					<div class="span3">
						<a href="#"> <span class="img_icon icon4"></span> <span
							class="link_title">Delivery</span> Door Delivery of Ordered
							Text-Books.
						</a>
					</div>
				</div>
		...
		<div class="wrap block">
			<div class="container welcome_block">
				...
				<p>
				<h2 style="font-size: 27px; font-weight: bold;">
					<u>Pustaka</u>
				</h2>
				is a complete collection of all Study-Materials require for
				Students, Professionals and Everyone.
				</p>
				<p>Our Trusted Partners are</p>
				<span Style="font-weight: bold; font-size: 22px;">Sakha
					Global, Oracle, W3-Schools, Pearson Publications...!</span>
				...
				<div class="row">
					<div class="span12">
						<ul id="mycarousel" class="jcarousel-skin-tango">
							<li>
								<div class="hover_img">
									<img src="img/featured_works/c-logo.png" alt="C-Materials"
							...
							<li>
								<div class="hover_img">
									<img src="img/featured_works/html-css-logo.png"
										alt="Java-Materials" />
								</div>
							</li>
							<li>
								<div class="hover_img">
									<img src="img/featured_works/javaScript.png"
										alt="Java-Materials" />
								</div>
							</li>
							<li>
								<div class="hover_img">
									<img src="img/featured_works/Angularlogo.jpg"
										alt="Java-Materials" />
								</div>
							</li>
							<li>
								<div class="hover_img">
									<img src="img/featured_works/bootstrap-logo.jpeg"
										alt="Java-Materials" />
								</div>
							</li>
							<li>
								<div class="hover_img">
									<img src="img/featured_works/pythonlogo.png"
										alt="Java-Materials" />
								</div>
							</li>
							<li>
							...
							<li>
								<div class="hover_img">
									<img src="img/featured_works/mysql-logo.jpg"
										alt="Java-Materials" />
								</div>
							</li>
		...
		<div class="wrap block">
			...
			<div class="wrap block carousel_block">
								...
								<div class="span3">
									...
									<form action="#" method="post">
										<input class="span3" type="text" name="name" id="name"
											...
											class="span3" type="text" name="email" id="email"
											value="Email"
							...
							<div class="row">
								<div class="span12">
									<div style="font-weight: bolder; text-align: center;">
										Copyrights &copy <u>PUSTAKA</u> Inc. 2017
									</div>
								</div>
							</div>
						</div>
				...
				<script type="text/javascript"
					src="js/jquery.mobile.customized.min.js"></script>
